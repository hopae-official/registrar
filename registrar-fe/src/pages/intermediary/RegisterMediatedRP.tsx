...
export default function RegisterMediatedRP() {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
      <button
        type="button"
        onClick={() => navigate(`/dashboard/intermediary/${intermediaryId}`)}
      ...
      <div className="mb-6 flex items-start gap-3">
        ...
        <div className="space-y-1">
          <h1 className="text-2xl font-semibold tracking-tight">Register Mediated Relying Party</h1>
          <p className="text-muted-foreground">
            Register a Relying Party that will use your intermediary services to connect with EUDI
            Wallets.
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Provide the legal identity and contact information for the mediated Relying Party.
          </CardDescription>
          <CardAction>
